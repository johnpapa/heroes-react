    ...
    <div className="card edit-detail">
      ...
      <div className="card-content">
        <div className="content">
          ...
          <InputDetail name="name" value={hero.name} placeholder="e.g Colleen" onChange={handleNameChange} />
          <InputDetail
            name="description"
      ...
      <footer className="card-footer ">
        <ButtonFooter className="cancel-button" iconClasses="fas fa-undo" onClick={handleCancelHero} label="Cancel" />
        <ButtonFooter className="save-button" iconClasses="fas fa-save" onClick={handleSave} label="Save" />
      </footer>
    </div>
  );
}
